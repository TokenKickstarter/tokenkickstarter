...
// File contracts/ChainlinkFeeManagerUpgradeable.sol
...
/**
 * @title ChainlinkFeeManagerUpgradeable
 * @dev Base contract for USD-denominated fee charging using Chainlink price feeds
 * @notice Upgradeable version for UUPS proxy contracts
 * 
 * Created by TokenKickstarter — https://tokenkickstarter.com
 */
abstract contract ChainlinkFeeManagerUpgradeable is OwnableUpgradeable {
    // ==================================