...
// File contracts/TKSContributionCollector.sol
...
/**
 * @title ITKSClaimVault
 * @dev Simple interface for the TKS Claim Vault
 */
interface ITKSClaimVault {
    function increaseClaimable(address user, uint256 amount) external;
}
